...
There are a few more variables we define as well that assist in our analysis. We create two np arrays of length 100, all filled with zeros. These are to track the player's positions after each dice roll, both before and after taking the snakes and ladders.
